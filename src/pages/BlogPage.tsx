...
export default function BlogPage() {
  useSeo("Blog | Bekzat", "Engineering writing on Python backend architecture, performance, and reliability.");

  return (
    <div className="mx-auto w-[min(980px,90%)] py-20">
      <h1 className="text-4xl font-bold text-white md:text-5xl">Blog</h1>
      <p className="mt-4 max-w-2xl text-slate-300">Notes and essays about backend systems, engineering trade-offs, and production lessons.</p>
